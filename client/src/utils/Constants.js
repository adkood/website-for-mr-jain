...
export const tech_list = [{
    id: '1', image: 'https://i.ibb.co/89ym8sG/casting.jpg', name: "Casting", short: 'Casting is a manufacturing process in which molten material, like metal, is poured into a mold and allowed to harden.', advantage: ["Continuous production of soft annealed copper in different shapes",
...
},
{
    ...
    ], prod_avail: [`Single, double and triple individual and overall insulated rectangular wire with Kraft paper, Thermally stabilized paper, Mica tape,
Nomex high temperature polyester etc`,
        "Sizes upto 400 S.mm max"], application: ["Oil filled transformer winding",
            "Dry type transformer winding",
            "Heavy duty motor / Generator",
            "Traction motors & other equipment"]
}, {
    id: '3', image: 'https://i.ibb.co/fDGtqnb/extrusion.png', name: "copper extrusion", short: 'Extrusion is a compressive forming manufacturing process that creates lengths of shaped cross-sections from metal billets.', advantage: ["Continuous production of soft annealed copper in different shapes",
        "High dimensional accuracy",
        "Defect free production in continuous length",
        "High electrical conductivity",
        "Production of complex cross sectional geometry"], prod_avail: ["Bare copper strip", "Rectangular wire", "Copper profile"], application: ["Earthing Conductor",
    ...
    id: '4', image: 'https://i.ibb.co/8xqq4Ld/drawing2.png', name: "copper drawing", short: 'This process allows artists to create intricate and detailed prints with fine lines and textures.', advantage: ["Suitable for fine wire drawing",
        ...
        "Easy to stringing up in wire drawing machine"], prod_avail: ["Rod breakdown wire 1.8 mm to 3.5 mm",
            ...
            "Fine wire 0.3 mm to 0.8 mm"], application: ["Extra flexible conductor for building wire, panel wire and welding cable",
                "HV, MV, LV Energy transmission with low heat development",
                "High frequency communication cable application",
                "Smooth and trouble free wire drawing during magnet wire enameling"]
}];
